...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=11931759373"
...
spawn(function()
   ...
   spawn(function()
    ...
    local Library = Update:Window("FIEND HUB","11931759373")
    local Main = Library:Tab("General","11446825283")
    local AutoMisc = Library:Tab("Setting","11446835336")
    local Swords = Library:Tab("Wepons/Items","11446859498")
    local Stats = Library:Tab("Stats","11447069304")
    local Combat = Library:Tab("Combats","11446900930")
    local Teleport = Library:Tab("Teleport/Esp","11446920523")
    local Dungeon = Library:Tab("Dungeon","11446957539")
    local DevilFruit = Library:Tab("Devil Fruit","11446965348")
    local Shop = Library:Tab("Shop","6031265976")
    local Misc = Library:Tab("Misc","11447063791")
    local Op = Library:Tab("Status","7040410130")
...
spawn(function()
 ...
 game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
  ...
  _G.Kill_At = 45
    Main:Slider1("Kill At %",1,100,45,function(value)
        _G.Kill_At = value
    end)
...
wait(1)
Notification:Notify(
   {Title = "FIEND HUB", Description = "You Have Max Observation"},
...
game.StarterGui:SetCore("SendNotification", {
								...
								Icon = "http://www.roblox.com/asset/?id=11931759373",
								Duration = 2.5
							})
...
game.StarterGui:SetCore("SendNotification", {
        Title = "Fiendhub"; -- the title (ofc)
        Text = "Mirage not Found!"; -- what the text says (ofc)
        Icon = "rbxassetid://11931759373"; -- the image if u want. 
...
local data = {
	["username"] = 'FIEND HUB', -- Webhook name here
...
AutoMisc:Toggle("Bring Mob [Extra+Lag]",false,function(value)
 _G.BringExtra = value
end)
...
Combat:Slider1("Farm (X)",1,100,1,function(value)
         getgenv().Xp = value
end)
end
    if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
...
Combat:Slider1("Farm (Y)",1,100,20,function(value)
         getgenv().Yp = value
    end)
end
    if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
...
Combat:Slider1("Farm (Z)",1,100,1,function(value)
        getgenv().Zp = value
    end)
end
...
Combat:Slider1("Distance Speed",1,50,15,function(value)
	speedSET = value
end)
end
...
Combat:Slider1("Fov Size",1,700,200,function(value)
		_G.FOVSize = value
	end)
end
	if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
...
Combat:Slider1("Fov Thickness",1,100,2,function(value)
		_G.Thicknessz = value
	end)
end
...
Combat:Slider1("Distance Up or Down",1,30,1,function(value)
        getgenv().Y = value
    end)
end
...
Combat:Slider1("Lock Bounty",1,25000000,750000,function(value)
        _G.BountyLock = value
    end)
end
...
Stats:Slider1("Select Point",1,100,1,function(value)
        _G.PointStats = value
    end)
end
...
spawn(function()
 ...
 if World1 then
    ...
    Teleport:Toggle("Teleport",_G.TeleportNPC,function(value)
       ...
       Teleport:Seperator("\\\\\  ESP  //")
    
    Teleport:Toggle("ESP Player",false,function(value)
        ESPPlayer = value
    ...
    Teleport:Toggle("ESP Chest",false,function(value)
        ChestESP = value
    ...
    Teleport:Toggle("ESP Fruit",false,function(value)
        DevilFruitESP = value
...
if World2 then
    Teleport:Toggle("ESP Flower",false,function(value)
        FlowerESP = value
    ...
    Teleport:Toggle("ESP Island",IslandESP,function(value)
        IslandESP = value
...
if World2 or World3 then
	Teleport:Toggle("ESP Sea Beast",SeaBeastsESP,function(value)
        SeaBeastsESP = value
...
if World3 then
	Teleport:Toggle("ESP Real Fruit",esprealfruit,function(a)
		RealFruitESP = a
...
Shop:Button("Random Race (Use 3K Fragments)", function()
  ...
  Misc:Button("Hop Lower Server",function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("FIEND HUB") then
            game.CoreGui:FindFirstChild("FIEND HUB"):Destroy()
...
Misc:Slider1("FPS Lock",0,499,60,function(K)setfpscap(tonumber(K));
    end)
end
